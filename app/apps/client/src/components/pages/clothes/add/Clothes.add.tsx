...
import { addedClothes, addedStatus, addClothes, updateAddStatus } from '../../../../redux/slices/clothes/addClothes.slice';
...
const ClothesAdd: FC = () => {
   ...
   const added = useAppSelector(addedClothes);
   ...
   const onSubmit = () => {
      if (name !== '' && description !== '' && category !== '' && producer !== '' && size !== '' && price !== 0) {
         ...
         dispatch(addClothes({ object, token }));
      } else {
