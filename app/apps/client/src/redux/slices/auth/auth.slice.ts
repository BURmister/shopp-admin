...
export const register = createAsyncThunk<IAuthResponse, IAuth>('auth/register', async ({ name, password }, thunkApi) => {
   try {
...
export const login = createAsyncThunk<IAuthResponse, IAuth>('auth/login', async ({ name, password }, thunkApi) => {
   try {
